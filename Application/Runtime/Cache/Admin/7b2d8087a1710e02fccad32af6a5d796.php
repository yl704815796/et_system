 ...
 <div id="page-wrapper">
    <div class="graphs">
      ...
      <div class="container">
                <table>
                  ...
                  <?php $i=0;?>
                  <?php if(is_array($ds)): foreach($ds as $key=>$d): ?><tr>
                      <td><?php echo ($d['wsid']); ?></td>
                      <td><?php echo ($d['tid']); ?></td>
                      <td><?php echo ($d['swid']); ?></td>                      
                      <td><button name="ts" value="<?php echo ($d['tstatus']); ?>" ></button></td>
                     
                      <td> 
                        <button name="as" id='<?php  echo $i; $i++;?>' value="<?php echo ($d['astatus']); ?>" onclick="change_status(<?php echo ($d['wsid']); ?>,this.value,this.id)"></button>
                    </td>
  ...
  <script type="text/javascript">
    ...
    function change_status(mession_id,status,id){
         ...
         xmlhttp.open('GET','/et_system/Admin/Work/ajax_change_status?mession_id='+mession_id+'&status='+status+'&',true);
         xmlhttp.send();
         //xmlhttp.close();
