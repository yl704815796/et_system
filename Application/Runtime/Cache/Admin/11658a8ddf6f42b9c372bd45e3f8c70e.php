 ...
 <div id="page-wrapper">
    <div class="graphs">
      <div class="panel panel-default">
        <div class="panel-heading page-title">编辑学期工作表</div>
      </div>
      ...
      <table>
        ...
        <?php if(is_array($dt)): foreach($dt as $key=>$d): ?><tr>
          <td><input type="text" name="swweek[]" value="<?php echo ($d['swweek']); ?>"></td>
          <td><input type="text" name="swcontent[]" value="<?php echo ($d['swcontent']); ?>"></td>
          <td>
            <input type="hidden" name="fv" value="<?php echo ($d['ftid']); ?>">
            <select class="evaluate_select" name="ftid[]" >
              <option id="0" value="0">无提交文件</option>';
              <option id="1" value="1">电子</option>';
              <option id="2" value="2">纸质</option>';
              <option id="3" value="3">电子+纸质</option>'; 

            </select></td>
          <td><input type="date" name="swfinishdate[]" value="<?php echo ($d['swfinishdate']); ?>"></td>
        </tr><?php endforeach; endif; ?>
      </table>
      <input type="submit"  value="保存">
      </form>
      <button><a href="/et_system/Admin/Work/work_table">返回</a></button>
      </div>
    </div>
  </div>
  ...
  function a() {
    for(var i=0;i<20;i++){
       var v = document.getElementsByName("fv")[i].value;
        if(v=="1"){
          document.getElementsByName("ftid[]")[i].value=v;        
       }else if(v=="2"){
          document.getElementsByName("ftid[]")[i].value=v;
       }else if(v=="3"){
          document.getElementsByName("ftid[]")[i].value=v;
